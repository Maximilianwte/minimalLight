    ...
    return (
      <div className="container fullPage" id="contact">
        <Helmet>
          ...
          <meta
            name="keywords"
            content="Contact, Kontakt, Light, Lightstrategies, Hamburg, Germany, Website, Design, Apps, Web App, Deutschland, Bots, Alexa Bot, Messenger Bot, Google Home Bot, Agency, Agentur, beauftragen, Schleswig-Holstein"
          />
        </Helmet>
        <div className="Head">
          <h2>Kontakt</h2>
